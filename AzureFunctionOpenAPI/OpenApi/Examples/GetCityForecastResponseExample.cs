...
{
    public class GetCityForecastResponseExample :
        OpenApiExample<GetCityForecastResponse>
    {
        public override IOpenApiExample<GetCityForecastResponse> Build(NamingStrategy namingStrategy = null)
        {
            var example = OpenApiExampleResolver.Resolve("first",
                new GetCityForecastResponse()
                {
                    CityName = "rome",
                    Forecast = new CityForecast()
                    {
                        Name = "Rome",
